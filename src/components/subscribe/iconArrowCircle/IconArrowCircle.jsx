...
export default function IconArrowCircle({ className = '', gradientToColor = false, isHover = false }) {
	let iconId = useId()
	...
	return (
		<svg className={className} viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" fill={`url(#${iconId})`}>
